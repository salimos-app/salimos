...
const telemetriaRouter = require('./routes/telemetria');
...
// Solo el registro anónimo y la telemetría mandan cuerpo; el resto del
// backend es un proxy de solo lectura. Tope bajo a propósito: los lotes de
// telemetría van acotados en cliente y servidor.
